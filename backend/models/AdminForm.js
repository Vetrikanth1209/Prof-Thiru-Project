...
const studentSchema = new mongoose.Schema({
  applicationNo: { type: String, required: true, unique: true, default: uuidv4 },
  admissionNo: { type: String, required: true, unique: true, default: uuidv4 },
  student_id: { type: String, required: true, unique: true, default: uuidv4 },
  feeId: { type: String, required: true, unique: true, default: uuidv4 },
  
  // Added student photo field
